...
describe('Property 1: Registration creates user and company', () => {
    ...
    it('should create both user and company for valid registration data', async () => {
        await fc.assert(fc.asyncProperty(validNameArbitrary, validEmailArbitrary, validPasswordArbitrary, validCompanyNameArbitrary, async (fullName, email, password, companyName) => {
            // Track for cleanup
...
describe('Property 2: Password validation rules', () => {
    ...
    it('should reject passwords shorter than 8 characters', () => {
        fc.assert(fc.property(shortPasswordArbitrary, (password) => {
    ...
    it('should reject mismatched passwords', () => {
        fc.assert(fc.property(validPasswordArbitrary, validPasswordArbitrary, (password, confirmPassword) => {
    ...
    it('should accept valid matching passwords of 8+ characters', () => {
        fc.assert(fc.property(validPasswordArbitrary, (password) => {
            const result = validatePassword(password, password);
...
describe('Property 3: Duplicate email prevention on registration', () => {
    ...
    it('should reject registration with duplicate email', async () => {
        await fc.assert(fc.asyncProperty(validNameArbitrary, validEmailArbitrary, validPasswordArbitrary, validCompanyNameArbitrary, validNameArbitrary, validCompanyNameArbitrary, async (name1, email, password, company1, name2, company2) => {
            // Track for cleanup
            createdUserEmails.push(email);
...
//# sourceMappingURL=registration.property.test.js.map