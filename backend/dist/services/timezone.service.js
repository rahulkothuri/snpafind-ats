 ...
 */
export function formatInTimezone(date, timezone, formatStr = 'PPpp') {
 ...
 */
export function formatDateTimeWithZone(date, timezone) {
 ...
 */
export function formatForEmail(date, timezone) {
 ...
 */
export function formatForCalendar(date, timezone) {
 ...
 */
export function toISOStringInTimezone(date, timezone) {
...
export function searchTimezones(query) {
    ...
    return getTimezoneList().filter(tz => tz.label.toLowerCase().includes(lowerQuery) ||
 ...
 */
export function getTimezoneByValue(timezone) {
 ...
 */
export function getTimezoneDifference(timezone1, timezone2, date = new Date()) {
