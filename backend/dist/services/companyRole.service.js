...
export const companyRoleService = {
     ...
     */
    async initializeDefaultRoles(companyId) {
        ...
        const createdRoles = await Promise.all(DEFAULT_ROLES.map((role) => prisma.companyRole.create({
            data: {
                companyId,
                name: role.name,
                description: role.description,
...
//# sourceMappingURL=companyRole.service.js.map