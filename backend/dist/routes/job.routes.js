 ...
 */
router.get('/:id/pipeline/analytics', authenticate, requireJobAccess(), async (req, res, next) => {
    try {
...
router.post('/', authenticate, requireJobCreatePermission(), async (req, res, next) => {
    try {
        ...
        const job = await jobService.create({
            ...
            autoRejectionRules: result.data.autoRejectionRules,
        });
 ...
 */
router.post('/:id/toggle-status', authenticate, requireJobUpdatePermission(), async (req, res, next) => {
    try {
 ...
 */
router.post('/:id/duplicate', authenticate, requireJobCreatePermission(), async (req, res, next) => {
    try {
 ...
 */
router.post('/:id/bulk-import', authenticate, requireJobAccess(), (req, res, next) => {
