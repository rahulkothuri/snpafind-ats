...
export function filterVendorJobs() {
  return async (req: AuthenticatedRequest, res: Response, next: NextFunction) => {
    try {
      ...
      (req as any).vendorJobIds = vendorJobIds;
 ...
 */
export function isVendor(req: AuthenticatedRequest): boolean {
 ...
 */
export function getVendorJobIds(req: AuthenticatedRequest): string[] | undefined {
  return (req as any).vendorJobIds;
}
