 ...
 */
router.get('/search', authenticate, async (req: AuthenticatedRequest, res: Response, next: NextFunction) => {
  try {
    const companyId = req.user?.companyId;
    if (!companyId) {
      return res.status(401).json({ code: 'UNAUTHORIZED', message: 'Company ID not found' });
 ...
 */
router.put('/:id/stage', authenticate, async (req: AuthenticatedRequest, res: Response, next: NextFunction) => {
  try {
 ...
 * Requirements: 24.3
 */
router.get('/:id/stages', authenticate, async (req: AuthenticatedRequest, res: Response, next: NextFunction) => {
  try {
 ...
 */
router.put('/:id/score', authenticate, async (req: AuthenticatedRequest, res: Response, next: NextFunction) => {
  try {
 ...
 * Requirements: 24.2
 */
router.get('/:id/activities', authenticate, async (req: AuthenticatedRequest, res: Response, next: NextFunction) => {
  try {
 ...
 * Requirements: 2.3
 */
router.get('/:id/stage-history', authenticate, async (req: AuthenticatedRequest, res: Response, next: NextFunction) => {
  try {
 ...
 */
router.get('/:id/notes', authenticate, async (req: AuthenticatedRequest, res: Response, next: NextFunction) => {
  try {
    const candidateId = req.params.id;
 ...
 */
router.post('/:id/notes', authenticate, async (req: AuthenticatedRequest, res: Response, next: NextFunction) => {
  try {
 ...
 * Requirements: 6.1
 */
router.delete('/:id/notes/:noteId', authenticate, async (req: AuthenticatedRequest, res: Response, next: NextFunction) => {
  try {
    const userId = req.user?.userId;
    if (!userId) {
      return res.status(401).json({ code: 'UNAUTHORIZED', message: 'User ID not found' });
 ...
 */
router.post('/:id/resume', authenticate, (req: AuthenticatedRequest, res: Response, next: NextFunction) => {
 ...
 */
router.get('/:id/attachments', authenticate, async (req: AuthenticatedRequest, res: Response, next: NextFunction) => {
  try {
    const candidateId = req.params.id;
 ...
 * Requirements: 6.4, 6.5
 */
router.post('/:id/attachments', authenticate, (req: AuthenticatedRequest, res: Response, next: NextFunction) => {
 ...
 * Requirements: 6.4
 */
router.delete('/:id/attachments/:attachmentId', authenticate, async (req: AuthenticatedRequest, res: Response, next: NextFunction) => {
  try {
    const userId = req.user?.userId;
    if (!userId) {
      return res.status(401).json({ code: 'UNAUTHORIZED', message: 'User ID not found' });
 ...
 * Requirements: 7.2
 */
router.post('/:id/tags', authenticate, async (req: AuthenticatedRequest, res: Response, next: NextFunction) => {
  try {
 ...
 * Requirements: 7.5
 */
router.delete('/:id/tags/:tag', authenticate, async (req: AuthenticatedRequest, res: Response, next: NextFunction) => {
  try {
 ...
 */
router.get('/tags/all', authenticate, async (req: AuthenticatedRequest, res: Response, next: NextFunction) => {
  try {
    const companyId = req.user?.companyId;
    if (!companyId) {
      return res.status(401).json({ code: 'UNAUTHORIZED', message: 'Company ID not found' });
